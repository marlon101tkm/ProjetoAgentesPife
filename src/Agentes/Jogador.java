...
public class Jogador extends Agent {
    ...
    public void imprimeMaoNormatizada() throws InterruptedException {
       ...
       LinkedList<Carta> resto = new LinkedList<Carta>();
...
//        System.out.println("Vencedor: " + nomeVencedor);
        ...
        imprimeCartasJog(tela, 50, 50, aux);
    }

    public void imprimeCartasJog(Component com, int x, int y, LinkedList<Carta> mao) throws InterruptedException {
...
//    public Component pegaComponente(Agent a) {
//        switch (a.getLocalName()) {
//            case "Jogador1":
//                return tela.getPanelJog1();
//            case "Jogador2":
//                return tela.getPanelJog2();
//            case "Jogador3":
//                return tela.getPanelJog3();
//            default:
//                return tela.getPanelJog4();
//        }
//    }
